...
namespace RiftARENA.Services
{
    ...
    public class tournamentService
    {
        ...
        {
            return _context.RiftArenaTournaments.ToList();
        }

        public Tournament GetById(long id)
        {
            return _context.RiftArenaTournaments.Find(id);
        }
        ...
        public Tournament CreateTournament(Tournament tournament)
        {
            ...
            _context.RiftArenaTournaments.Add(tournament);
        ...
        {
            var tournamentSer = _context.RiftArenaTournaments.Find(id);
            ...
            _context.RiftArenaTournaments.Update(tournament);
            _context.SaveChanges();
            return tournament;
        }
        ...
        {
            var tournament = _context.RiftArenaTournaments.Find(id);
            if (tournament != null)
            {
                _context.RiftArenaTournaments.Remove(tournament);  
                _context.SaveChanges();
            }
        }
    }
